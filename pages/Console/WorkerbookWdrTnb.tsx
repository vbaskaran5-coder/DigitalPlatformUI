...
const WorkerbookWdrTnb: React.FC = () => {
  ...
  useEffect(() => {
    const loadWorkers = () => {
      ...
      const filtered = allWorkers.filter((w) => w.bookingStatus === 'wdr_tnb');
      setWorkers(filtered);
    };
  ...
  return (
    <div className="px-6">
      <div className="flex items-center gap-2">
        <h2 className="text-lg font-medium text-white">WDR/TNB</h2>
...
export default WorkerbookWdrTnb;
